...
def allbut_target_model(target_geo,pollse,scenarios,pshares,ppshares,pshares_sc):
    ...
    for s in scenarios.scenario.unique():
        ...
        if len(scen) > 0:
            ...
            allbut_preds_weights = allbut_preds_weights.merge(scen\
            ...
            allbut_scen_daily_avgs[s] = daily_allbut_avg

        else:
            allbut_scen_daily_avgs[s] = None

    
    return daily_allbut_mse, daily_allbut_mae, allbut_scen_daily_avgs